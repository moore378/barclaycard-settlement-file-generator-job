...
REM netsh http delete urlacl https://+:56341/AuthorizationProcessors/Barclaycard-SmartPay
...
netsh http add urlacl url=https://+:56341/AuthorizationProcessors/Barclaycard-SmartPay sddl=D:(A;;GX;;;S-1-1-0)
